...
class AnalyticsMiddleware(BaseHTTPMiddleware):
    """
    Tracks API calls and records analytics.
    Integrates with AnalyticsCollector.
    """
    
    def __init__(self, app, analytics_collector=None):
        super().__init__(app)
    ...
    async def dispatch(self, request: Request, call_next: Callable):
        ...
        if auth_header.startswith("Bearer "):
            try:
                ...
                # If token invalid, keep as anonymous
                pass
        ...
        # Record analytics if collector available
        if self.analytics_collector and self.analytics_collector.health_check():
            try:
                self.analytics_collector.record_api_call(
